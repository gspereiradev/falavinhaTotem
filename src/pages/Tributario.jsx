      ...
      <HeroApp>
        <main className='hero'>
            ...
            <div className='textoMain'>
                <p>A <span style={{color: '#C48322', fontFamily: 'Gilroy-bold', fontSize: 24}}>{textos.tributario.PalavraChave}</span> {textos.tributario.Texto}</p>
            </div>
            <div className='link'>
                <Botoes onClick={() => navigate(routes.dashboardFinanceiro)} className= 'opcoes'>DASHBOARD BI TRIBUTÁRIO</Botoes>
