      ...
      <HeroApp>
        <main className='hero'>
            ...
            <div className='textoMain'>
                <p>A <span style={{color:'#582B6F', fontSize: 24, fontFamily: 'Gilroy-bold' }}>{textos.consultoriaRh.PalavraChave}</span> {textos.consultoriaRh.Texto}</p>
            </div>
            <div className='link'>
                <Botoes onClick={() => navigate(routes.dashboardFinanceiro)} className= 'opcoes'>DASHBOARD BI CONSULTORIA RH</Botoes>
